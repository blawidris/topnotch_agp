<?php
class ControllerExtensionMzDesignList extends maza\layout\Design {
    public function index(): void {
        $this->load->language('extension/mz_design/list');
        ...
        $this->response->setOutput($this->load->view('extension/mz_design/list', $data));
    }
}
