<?php
class ControllerExtensionMzContentQuickViewTags extends maza\layout\Content {
        private $error = array();
        
        public function index() {
                $this->load->language('extension/mz_content/quick_view/tags');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/quick_view/tags', $data));
        }
        
        protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/quick_view/tags')) {
