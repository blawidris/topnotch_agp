...
class ControllerExtensionMzContentProductsTitle extends maza\layout\Content {
        ...
        public function index() {
                $this->load->language('extension/mz_content/products/title');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/products/title', $data));
        }
        
        protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/products/title')) {
