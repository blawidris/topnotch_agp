...
class ControllerExtensionMzContentProductsProducts extends maza\layout\Content {
    ...
    public function index(): void {
        $this->load->language('extension/mz_content/products/products');
        ...
        $this->response->setOutput($this->load->view('extension/mz_content/products/products', $data));
    }
    
    protected function validateForm(): bool {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/products/products')) {
