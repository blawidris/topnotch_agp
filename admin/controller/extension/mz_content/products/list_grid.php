...
class ControllerExtensionMzContentProductsListGrid extends maza\layout\Content {
        ...
        public function index() {
                $this->load->language('extension/mz_content/products/list_grid');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/products/list_grid', $data));
        }
        
        protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/products/list_grid')) {
