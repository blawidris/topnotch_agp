...
class ControllerExtensionMzContentBlogAuthorDescription extends maza\layout\Content {
        ...
        public function index() {
                $this->load->language('extension/mz_content/blog_author/description');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/blog_author/description', $data));
        }
        
        protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/blog_author/description')) {
