<?php
class ControllerExtensionMzContentBlogAuthorArticles extends maza\layout\Content {
        private $error = array();
        
        public function index() {
                $this->load->language('extension/mz_content/blog_author/articles');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/blog_author/articles', $data));
        }
        
        protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/blog_author/articles')) {
