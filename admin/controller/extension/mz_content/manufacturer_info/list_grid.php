<?php
class ControllerExtensionMzContentManufacturerInfoListGrid extends maza\layout\Content {
        private $error = array();
        
        public function index() {
                $this->load->language('extension/mz_content/manufacturer_info/list_grid');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/manufacturer_info/list_grid', $data));
        }
        
        protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/manufacturer_info/list_grid')) {
