<?php
class ControllerExtensionMzContentProductDynamic extends maza\layout\Content {
    public function index(): void {
        $this->load->language('extension/mz_content/product/dynamic');
        ...
        $setting['content_condition_option'] = '';
        $setting['content_condition_tax_class_id'] = '';
        $setting['content_condition_twig'] = '';
        ...
        // Content
        $data['contents'] = $this->model_extension_maza_extension->getContentsOfType('product');
        ...
        $this->response->setOutput($this->load->view('extension/mz_content/product/dynamic', $data));
    }
    ...
    public function merger(string $route, array $param): void {
        ...
        $this->event->unregister('model/extension/maza/install/merger/content/after', 'extension/mz_content/product/dynamic/merger');
        $this->event->unregister('model/extension/maza/install/merger/design/after', 'extension/mz_content/product/dynamic/merger');

        $this->model_extension_maza_install_merger->content('product.dynamic', function($setting) use($type, $code, $data) {
            $isEdited = false;
