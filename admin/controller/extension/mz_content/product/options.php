<?php
class ControllerExtensionMzContentProductOptions extends maza\layout\Content {
        private $error = array();
        
        public function index() {
                $this->load->language('extension/mz_content/product/options');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/product/options', $data));
        }
        
        protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/mz_content/product/options')) {
