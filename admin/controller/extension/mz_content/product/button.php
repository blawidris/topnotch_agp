...
class ControllerExtensionMzContentProductButton extends maza\layout\Content {
	private $error = array();
        ...
        public function index() {
                ...
                // Settings
                if(isset($this->request->post['content_stock_status'])){
                    $data['content_stock_status'] = $this->request->post['content_stock_status'];
                } else {
                    $data['content_stock_status'] =  1;
                }
		...
		if (!$this->user->hasPermission('modify', 'extension/mz_content/product/button')) {
