...
class ControllerExtensionMzContentCategoryRefineSearch extends maza\layout\Content {
        ...
        public function index() {
                $this->load->language('extension/mz_content/category/refine_search');
                ...
                if(isset($this->request->post['content_design'])){
                    ...
                    $data['content_design'] =  'grid';
                }

                $data['list_design'] = array(
                    array('code' => 'list', 'text' => $this->language->get('text_list')),
                    array('code' => 'grid', 'text' => $this->language->get('text_grid')),
                );
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/category/refine_search', $data));
        }
}
