<?php
class ControllerExtensionMzContentBlogAllArticles extends maza\layout\Content {
        public function index() {
                $this->load->language('extension/mz_content/blog_all/articles');
                ...
                $this->response->setOutput($this->load->view('extension/mz_content/blog_all/articles', $data));
        }
}
