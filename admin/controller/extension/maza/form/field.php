...
class ControllerExtensionMazaFormField extends Controller {
    ...
    public function getList(): void {
        ...
        $header_data['menu'] = array(
            array('name' => $this->language->get('tab_form'), 'id' => 'tab-mz-form', 'href' => $this->url->link('extension/maza/form', 'user_token=' . $this->session->data['user_token'] . $url, true)),
            array('name' => $this->language->get('tab_field'), 'id' => 'tab-mz-field', 'href' => false),
    ...
    protected function validateForm(): bool {
        ...
        foreach ($this->request->post['field_description'] as $language_id => $value) {
			if ((utf8_strlen($value['label']) < 1) || (utf8_strlen($value['label']) > 60)) {
