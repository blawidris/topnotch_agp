...
class ControllerExtensionMazacatalog extends Controller {
    ...
    public function index(): void {
        ...
        $header_data['menu'] = array(
            ...
            // array('name' => $this->language->get('tab_order'), 'id' => 'menu-order', 'href' => false),
            // array('name' => $this->language->get('tab_deal'), 'id' => 'menu-special-deal', 'href' => false),
        ...
        // Product listing
        $setting['catalog_sale_badge_status']       = 1;
        $setting['catalog_sale_badge_type']         = 'text';
        $setting['catalog_new_badge_status']        = 1;
        $setting['catalog_new_badge_timeout']       = 7;
