...
class ControllerExtensionMazaInstallEngine extends Controller {
        public function index() {
            ...
            // if(empty($this->session->data['mz_startup'])){
            //     $data['startup']  = $this->url->link('extension/maza/install/engine/startup', $url, true);
            // }
            if(empty($this->session->data['mz_database'])){
                $data['database']  = $this->url->link('extension/maza/install/engine/database', $url, true);
            }
            // if(empty($this->session->data['mz_event'])){
            //     $data['event']  = $this->url->link('extension/maza/install/engine/event', $url, true);
            // }
        ...
        //     if(isset($this->session->data['mz_startup'])){
        //         $json['next'] = 1;
        //     }
                
        //     if(!$json && !$this->config->get('mz_version') && !is_writable(DIR_SYSTEM . 'framework.php')){
        //         $json['error'] = $this->language->get('error_write');
        //     }
        ...
        //         $this->model_extension_maza_install->addStartup();
                
        //         // Success
        //         $json['next'] = $this->session->data['mz_startup'] = 1;
        ...
        //         if(isset($this->session->data['mz_event'])){
        //             $json['next'] = 1;
        //         }
        ...
        //             $this->model_extension_maza_install->addEvents();
                    
        //             // Success
        //             $json['next'] = $this->session->data['mz_event'] = 1;
