...
class ControllerExtensionMazaCode extends Controller {
        ...
        public function index() {
                ...
                // CSS
                $css_global_file        =   DIR_CATALOG . 'view/javascript/maza/custom_code/css/global.css';
                $css_theme_file         =   DIR_CATALOG . 'view/javascript/maza/custom_code/css/' . $this->mz_theme_config->get('theme_code') . '.css';
                $css_skin_file          =   DIR_CATALOG . 'view/javascript/maza/custom_code/css/' . $this->mz_theme_config->get('theme_code') . '.skin.' . $this->mz_skin_config->get('skin_id') . '.css';
                
                // Javascript
                $javascript_global_file        =   DIR_CATALOG . 'view/javascript/maza/custom_code/js/global.js';
                $javascript_theme_file         =   DIR_CATALOG . 'view/javascript/maza/custom_code/js/' . $this->mz_theme_config->get('theme_code') . '.js';
                $javascript_skin_file          =   DIR_CATALOG . 'view/javascript/maza/custom_code/js/' . $this->mz_theme_config->get('theme_code') . '.skin.' . $this->mz_skin_config->get('skin_id') . '.js';
                
                // Header
                $header_global_file        =   DIR_CATALOG . 'view/javascript/maza/custom_code/header/global.html';
                $header_theme_file         =   DIR_CATALOG . 'view/javascript/maza/custom_code/header/' . $this->mz_theme_config->get('theme_code') . '.html';
                $header_skin_file          =   DIR_CATALOG . 'view/javascript/maza/custom_code/header/' . $this->mz_theme_config->get('theme_code') . '.skin.' . $this->mz_skin_config->get('skin_id') . '.html';
                
                // Footer
                $footer_global_file        =   DIR_CATALOG . 'view/javascript/maza/custom_code/footer/global.html';
                $footer_theme_file         =   DIR_CATALOG . 'view/javascript/maza/custom_code/footer/' . $this->mz_theme_config->get('theme_code') . '.html';
                $footer_skin_file          =   DIR_CATALOG . 'view/javascript/maza/custom_code/footer/' . $this->mz_theme_config->get('theme_code') . '.skin.' . $this->mz_skin_config->get('skin_id') . '.html';
