...
class ControllerExtensionMazaCatalogDocument extends Controller {
    ...
    public function getList(): void {
        ...
        $header_data['menu'] = array(
            array('name' => $this->language->get('tab_product'), 'id' => 'tab-mz-product', 'href' => $this->url->link('extension/maza/catalog/product', 'user_token=' . $this->session->data['user_token'] . $url, true)),
            ...
            array('name' => $this->language->get('tab_document'), 'id' => 'tab-mz-document', 'href' => false),
        );
    ...
    protected function getForm(): void {
        ...
        $header_data['buttons'][] = array(
            ...
            'icon' => 'fa-info',
            'class' => 'btn-default',
            'href' => 'https://docs.pocotheme.com/#page-document-add',
            'target' => '_blank'
        );
        $header_data['form_target_id'] = 'form-mz-document';
