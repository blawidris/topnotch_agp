...
class ControllerExtensionMazaSystem extends Controller {
    ...
    public function index(): void {
        ...
        // Cron url
        if($_SERVER['HTTPS']){
            $data['cron_url'] = HTTPS_CATALOG . 'index.php?route=extension/maza/cron&username=[USERNAME]&password=[PASSWORD]';
        } else {
            $data['cron_url'] = HTTP_CATALOG . 'index.php?route=extension/maza/cron&username=[USERNAME]&password=[PASSWORD]';
        }
