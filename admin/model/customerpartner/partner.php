	...
	public function approve($customer_id, $setstatus = 1)
	{
		...
		if ($customer_info) {
			...
			if ($seller_info) {
				...
				// $this->db->query("UPDATE " . DB_PREFIX . "customer SET account_type = '" . $this->db->escape(utf8_strtolower($user_account_type)) . "' WHERE customer_id = '" . (int)$customer_id . "'");
			} else {
