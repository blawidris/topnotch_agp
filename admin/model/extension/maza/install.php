...
class ModelExtensionMazaInstall extends model {
        ...
        //     $this->deleteEvents();
            ...
            //     $this->model_extension_maza_opencart->addEvent('mz_admin_core_before_delete_module', 'admin/model/extension/module/deleteModule/before', 'extension/maza/event/setting/module/deleteModule');
            // } else {
            //     $this->model_extension_maza_opencart->addEvent('mz_admin_core_before_delete_module', 'admin/model/setting/module/deleteModule/before', 'extension/maza/event/setting/module/deleteModule');
            // }
            
            // $this->model_extension_maza_opencart->addEvent('mz_admin_core_before_delete_layout', 'admin/model/design/layout/deleteLayout/before', 'extension/maza/event/design/layout/deleteLayout');
            // $this->model_extension_maza_opencart->addEvent('mz_admin_core_column_left_view', 'admin/view/common/column_left/before', 'extension/maza/event/common/menu');
            // $this->model_extension_maza_opencart->addEvent('mz_admin_core_before_delete_category', 'admin/model/catalog/category/deleteCategory/before', 'extension/maza/event/catalog/deleteCategory');
            // $this->model_extension_maza_opencart->addEvent('mz_admin_core_before_delete_manufacturer', 'admin/model/catalog/manufacturer/deleteManufacturer/before', 'extension/maza/event/catalog/deleteManufacturer');
            // $this->model_extension_maza_opencart->addEvent('mz_admin_core_before_delete_product', 'admin/model/catalog/product/deleteProduct/before', 'extension/maza/event/catalog/deleteProduct');
            
            
            //** Catalog **********************************
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_before_header_view', 'catalog/view/common/header/before', 'extension/maza/event/common/header/index');
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_before_footer_view', 'catalog/view/common/footer/before', 'extension/maza/event/common/footer/index');
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_before_view', 'catalog/view/*/before', 'extension/maza/event/common/beforeView');
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_product_before_getProducts_model', 'catalog/model/catalog/product/getProducts/before', 'extension/maza/event/common/product/getProducts');
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_product_before_getTotalProducts_model', 'catalog/model/catalog/product/getTotalProducts/before', 'extension/maza/event/common/product/getTotalProducts');
            
            // Layout content
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_before_column_left_view', 'catalog/view/common/column_left/before', 'extension/maza/event/common/content');
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_before_column_right_view', 'catalog/view/common/column_right/before', 'extension/maza/event/common/content');
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_before_content_top_view', 'catalog/view/common/content_top/before', 'extension/maza/event/common/content');
            // $this->model_extension_maza_opencart->addEvent('mz_catalog_core_before_content_bottom_view', 'catalog/view/common/content_bottom/before', 'extension/maza/event/common/content');
        // }
        ...
        public function updateDatabase(){
            ...
            if(!in_array('mz_override_skin', $field)){
                $this->db->query("ALTER TABLE `" . DB_PREFIX . "layout` ADD COLUMN `mz_override_skin` TEXT");
            }
            ...
            //     $this->db->query("ALTER TABLE `" . DB_PREFIX . "product` ADD COLUMN `mz_video` VARCHAR(1000)");
            // }
            ...
            if(!in_array('mz_text',$key_names)){
                $this->db->query("CREATE INDEX mz_text ON " . DB_PREFIX . "product_attribute (`text`)");
            }
