...
class ControllerExtensionMazaProductQuickView extends Controller {
        ...
        public function index() {
                ...
                $data['styles'][] = 'catalog/view/javascript/maza/javascript/datetimepicker/bootstrap-datetimepicker.min.css';
                $data['styles'][] = 'catalog/view/javascript/jquery/swiper/css/swiper.min.css';
                ...
                $data['scripts'][] = 'catalog/view/javascript/maza/javascript/datetimepicker/moment/moment.min.js';
                $data['scripts'][] = 'catalog/view/javascript/maza/javascript/datetimepicker/moment/moment-with-locales.min.js';
                $data['scripts'][] = 'catalog/view/javascript/maza/javascript/datetimepicker/bootstrap-datetimepicker.min.js';
