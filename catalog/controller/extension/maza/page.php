...
class ControllerExtensionMazaPage extends Controller {
	public function index() {
		...
		if ($page_info) {
			...
			$this->mz_cache->setVar('page_component', $this->load->controller('extension/maza/layout_builder', ['group' => 'page_component', 'group_owner' => $this->request->get['page_id']]));
                        
			$data['content'] = $this->load->controller('extension/maza/layout_builder', ['group' => 'page', 'group_owner' => $this->request->get['page_id']]);
