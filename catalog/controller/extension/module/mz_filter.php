...
class ControllerExtensionModuleMzFilter extends maza\layout\Module {
        ...
        public function index(array $setting) {
                ...
                $this->document->addStyle('catalog/view/javascript/maza/javascript/jquery-ui-1.12.1/jquery-ui.min.css');
                $this->document->addScript('catalog/view/javascript/maza/javascript/jquery-ui-1.12.1/jquery-ui.min.js');
                $this->document->addScript('catalog/view/javascript/maza/javascript/jquery-ui-1.12.1/jquery.ui.touch-punch.min.js');
                $this->document->addScript('catalog/view/javascript/maza/javascript/filter.js');
        ...
        private function productTemplate(): string {
                ...
                switch($this->request->get['target_route']){
                    case 'product/category': $type = 'category';
                        break;
                    case 'product/special': $type = 'special';
                        break;
                    case 'product/search': $type = 'search';
                        break;
                    case 'product/manufacturer/info': $type = 'manufacturer_info';
                        break;
                }
        ...
        private function getPostFilterValues(): array {
                ...
                if(isset($this->request->get['_f_rating'])){
                    ...
                    foreach($ratings as $rating){
                        $data['rating'][$rating['rating']] = array(
                            'rating' => $rating['rating'],
