...
class ControllerExtensionModuleMzSlider extends maza\layout\Module {
    ...
    public function index(array $module_setting) {
        ...
        if($setting['lazy_loading']){
            $this->document->addScript('//cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.9/jquery.lazy.min.js');
            $this->document->addScript('//cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.9/jquery.lazy.plugins.min.js');
        }
...
//                $data['slide_direction']     = $setting['slide_direction'];
     ...
     */
    private function getSlides($setting){
        $slides = array();
