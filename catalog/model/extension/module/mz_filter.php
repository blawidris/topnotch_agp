...
class ModelExtensionModuleMzFilter extends model
{
     ...
     */
     ...
     public function getCategories(string $product_table, $parent_id, array $data = array()): array
    {
        ...
        $sql .= "LEFT JOIN " . DB_PREFIX . "category_to_store c2s ON (c.category_id = c2s.category_id) WHERE c.parent_id = '" . (int)$parent_id  . "' AND c.status = '1' AND c2s.store_id = '" . (int)$this->config->get('config_store_id') . "'";
     ...
     */
    public function getTotalProductsByStock(string $product_table, bool $stock_status, array $data = array()): int
    {
