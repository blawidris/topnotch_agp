...
abstract class Module extends \Controller{
    ...
    protected function getCache(string $key){
        return $this->mz_cache->get($this->mz_theme_config->get('theme_code') . '.' . $this->mz_skin_config->get('skin_code') . '.' . $this->mz_skin_config->get('skin_id') . '.' . $this->config->get('config_store_id') . '.module.' . $key . '-l' . $this->config->get('config_language_id'));
    }
    ...
    protected function setCache(string $key, $value, $expire = true): void {
        $this->mz_cache->set($this->mz_theme_config->get('theme_code') . '.' . $this->mz_skin_config->get('skin_code') . '.' . $this->mz_skin_config->get('skin_id') . '.' . $this->config->get('config_store_id') . '.module.' . $key . '-l' . $this->config->get('config_language_id'), $value, $expire);
    }
