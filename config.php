<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/topnotch_agp/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/topnotch_agp/');

// DIR
define('DIR_APPLICATION', 'C:/xampp/htdocs/topnotch_agp/catalog/');
